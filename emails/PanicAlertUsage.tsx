...
import { basePath } from "../export-to-html";
...
const PanicAlertUsage = ({
	...
	const previewText = "Panic Alert Usage";
						...
						<Section className="mt-[32px] bg-white p-[20px] rounded-lg shadow">
							...
							<Section className="grid justify-center my-[2rem]">
								...
								<Text className="text-black text-[14px] my-1 ">
									...
									that there has been an update to the Panic Alert fee.
								</Text>
							</Section>
