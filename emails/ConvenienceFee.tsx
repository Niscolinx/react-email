...
interface Props {
	adminName: string;
	estatePercentage: string;
	sesaPercentage: string;
...
const ConvenienceFee = ({
	...
	estatePercentage = "[estate_percentage]",
	sesaPercentage = "[sesa_percentage]",
	...
	const previewText = "Convenience Fee";
						...
						<Section className="mt-[32px] bg-white p-[20px] rounded-lg shadow">
							...
							<Section className="grid justify-center my-[2rem]">
								...
								<Text className="text-black text-[14px] my-1 ">
									...
									that there has been an update to the Convenience Fee Split.
									The new split percentages are as follows:
								</Text>
							</Section>
